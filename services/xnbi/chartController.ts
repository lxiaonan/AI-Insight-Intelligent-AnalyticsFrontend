...
export async function genChartByAiUsingPost(
  ...
  return request<API.BaseResponseAIResultDto_>('/api/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsync POST /api/chart/gen_async */
export async function genChartByAiAsyncUsingPost(
  ...
  return request<API.BaseResponseAIResultDto_>('/api/chart/gen_async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsyncMq POST /api/chart/gen_async/mq */
export async function genChartByAiAsyncMqUsingPost(
  ...
  return request<API.BaseResponseAIResultDto_>('/api/chart/gen_async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
